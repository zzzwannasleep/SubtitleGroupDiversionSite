...
TRACKER_INTERNAL_ANNOUNCE_URL = env("TRACKER_INTERNAL_ANNOUNCE_URL", "").rstrip("/")
TRACKER_SCRAPE_URL = env("TRACKER_SCRAPE_URL", "").rstrip("/")
TRACKER_PUBLIC_SCRAPE_URL = env("TRACKER_PUBLIC_SCRAPE_URL", "").rstrip("/")
TRACKER_AUTH_URL_STYLE = env("TRACKER_AUTH_URL_STYLE", "suffix")
...
TRACKER_PEER_SNAPSHOT_STALE_SECONDS = int(env("TRACKER_PEER_SNAPSHOT_STALE_SECONDS", "900") or "900")
...
WEBSEED_LIBRARY_ROOT = env_path("WEBSEED_LIBRARY_ROOT", MEDIA_ROOT / "webseed")
